...
var recordsToMarkAsSynced = function ({
  ...
  Object.keys(changes).forEach(function (table) {
    ...
    raws.forEach(function (raw) {
      var {
        id: id
      } = raw; // TODO: assumes global (not per-table) id uniqueness
      ...
      if (!record) {
        (0, _common.logError)("[Sync] Looking for record ".concat(id, " to mark it as synced, but I can't find it. Will ignore it (it should get synced next time). This is probably a Watermelon bug \u2014 please file an issue!"));
        return;
      }
